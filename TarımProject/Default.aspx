<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="TarımProject.Default" %>
            ...
            <div class="container-fluid px-lg-4">
                <nav class="py-4">
                    ...
                    <ul class="menu mt-md-3">
                        ...
                        <li class="mr-lg-2"><a href="#services" class="scroll">Hizmetlerimiz</a></li>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="style-banner">
                        <h1 class="text-white">Tarım Dünyamıza Hoş Geldiniz</h1>
